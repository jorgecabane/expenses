...
export default function LoginForm() {
  ...
  // Verificar si hay un código de OAuth en la URL (redirección incorrecta)
  useEffect(() => {
    ...
    // El redirect se pasa como query param al OAuth, no necesitamos guardarlo aquí
  }, [searchParams])
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Para login con email/password, usar el redirect de la URL
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-[#030712] text-white/40">o continúa con email</span>
        </div>
      </div>
